...
export default {
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "quotation");
  ...
  methods : {
    ...
    onPrintDetail(item){
      ...
      window.open(process.env.API_URL + "/marketing/quotation/get-print-detail/" + item.id + "?token="+token, '_blank');    
    }
  }
}
</script>